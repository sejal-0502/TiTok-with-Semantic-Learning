...
from visual_tokenization.taming.modules.diffusionmodules.model import nonlinearity, ResnetBlock, AttnBlock, Normalize, Upsample
...
class EncoderVIT(nn.Module):
    ...
    def forward(self, img: torch.FloatTensor) -> torch.FloatTensor:
        ...
        x = x.reshape(x.shape[0], x.shape[1]//ft_h, x.shape[1]//ft_w, -1)
