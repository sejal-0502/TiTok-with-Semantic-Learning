...
def main(args):
  # input_folder = '/misc/lmbraid19/mittal/datasets/BDD100K/bdd100k/images/100k/test/'
...
if __name__ == "__main__":
  ...
  parser.add_argument("--input_folder", type=str, default="/misc/lmbraid19/mittal/datasets/BDD100K/bdd100k/images/100k/test/", help="Path to input data folder")
  #parser.add_argument("--input_folder", type=str, default="/misc/lmbraid19/datasets/nuImages/samples/CAM_FRONT/", help="Path to input data folder")
  ...
  if (args.config_path is None or args.ckpt_path is None):
     ...
     if not (os.path.exists(args.config_path) and os.path.exists(args.ckpt_path)):
        args.config_path = os.path.join("/misc/lmbraid21/mittal/repos/taming-transformers/logs", args.exp_name, "config.yaml")
        args.ckpt_path = os.path.join("/misc/lmbraid21/mittal/repos/taming-transformers/logs", args.exp_name, "checkpoints", "last.ckpt")
